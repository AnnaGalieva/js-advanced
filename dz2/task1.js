...
class Library {
    ...
    //методы получения информации о наличии книги
    hasBook(title) {
    ...
    constructor(bookArray) {
        bookArray.map(book => {
            if (this.#books.includes(book)) throw new Error(`Книга ${book} уже есть в библиотеке`);
...
console.log(library.addBook('"T"'));
console.log(library.hasBook('"A"'));
console.log(library.hasBook('"P"'));